...
#import "AGViewController-Private.h"
#import "AGViewControllerProxy.h"
...
#if AG_EXPORT_NODES
    AGNodeInfoExporter::exportNodeInfoToFile(AG_EXPORT_NODES_FILE);
