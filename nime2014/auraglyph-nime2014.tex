...
Systems for designed (or repurporsed) for live-coding such as SuperCollider~\cite{mccartney2002supercollider}, ChucK~\cite{wang2008chuck}, ixi lang~\cite{magnusson2011ixi}, and Overtone~\cite{aaron2013overtone} also suggest interesting possibilities for the use of natural input for music programming. 
The Reactable~\cite{jorda2007reactable} and the work of Davidson and Han~\cite{davidson2006synthesis} have both provided significant foundational work in interacting with digital music via touchscreen. 
