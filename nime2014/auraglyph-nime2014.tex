...
Most notably, Garcia et al. studied the use of handwritten sketches and outlines as a preliminary exercise in electronic composition and used this study to inform the application of a digital stroke-sensing pen to real-time musical synthesis, as an aid to the compositional process~\cite{garcia2011inksplorer}. 
...
Systems designed (or repurporsed) for live-coding such as SuperCollider~\cite{mccartney2002supercollider}, ChucK~\cite{wang2008chuck}, and Overtone~\cite{aaron2013overtone} also suggest interesting possibilities for the expressive use of natural input for music programming. 
...
This principle is made especially evident in the aforementioned Smule applications, Ocarina, Leaf Trombone, and others. 
...
Evidenced by both the direct experience of the authors and the previously mentioned work of Garcia et al., handwritten planning is a vital component of many compositional processes, whether the resulting musical product is electronic, acoustic, or both. 
More generally, writing and drawing with a pen or pencil on a flat surface is a foundational expressive interaction for an incredible number of individuals; this activity is continuously developed from early education around the world. 
A primary goal of software interfaces is to simplify the mapping between the user's conceptual abstraction of an idea and translating that idea to a digital representation. 
