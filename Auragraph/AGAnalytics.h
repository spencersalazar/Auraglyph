...
public:
    ...
    virtual void eventCreateAudioNode(const std::string &type) = 0;
    virtual void eventCreateControlNode(const std::string &type) = 0;
    virtual void eventCreateInputNode(const std::string &type) = 0;
    virtual void eventCreateOutputNode(const std::string &type) = 0;
